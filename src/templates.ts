...
export const templates: DocTemplate[] = [
  // 1. BÁO GIÁ
  {
    id:'quotation', icon:'💰', title:'Báo Giá', desc:'Tạo báo giá chuyên nghiệp cho khách hàng', badge:'Phổ biến',
    hasItems: true,
    fields: [
...
${renderSig(d.company_name||'','')}`;
  ...
  // 2. HÓA ĐƠN
  {
    id:'invoice', icon:'🧾', title:'Hóa Đơn', desc:'Tạo hóa đơn bán hàng / dịch vụ', badge:'Phổ biến',
    hasItems: true,
    fields: [
...
${renderSig('Người bán','Người mua')}`;
  ...
  // 3. HỢP ĐỒNG THUÊ NHÀ
  {
    id:'rental', icon:'🏠', title:'Hợp Đồng Thuê Nhà', desc:'Hợp đồng cho thuê nhà/căn hộ theo Bộ luật Dân sự 2015', badge:'Bất động sản',
    fields: [
      ...partyFields,
...
<p style="text-indent:2em">Căn cứ Luật Nhà ở số 65/2014/QH13 ngày 25/11/2014;</p>
...
${renderSig(d.a_name||'',d.b_name||'')}`;
  ...
  // 4. HỢP ĐỒNG DỊCH VỤ
  {
    id:'service', icon:'🤝', title:'Hợp Đồng Dịch Vụ', desc:'Hợp đồng cung cấp dịch vụ theo Luật Thương mại 2005',
    fields: [
      ...partyFields,
...
<p style="text-indent:2em">Căn cứ Bộ luật Dân sự số 91/2015/QH13;</p>
<p style="text-indent:2em">Căn cứ Luật Thương mại số 36/2005/QH11;</p>
...
${renderSig(d.a_name||'',d.b_name||'')}`;
  ...
  // 5. HỢP ĐỒNG MUA BÁN
  {
    id:'sales', icon:'📦', title:'Hợp Đồng Mua Bán', desc:'Hợp đồng mua bán hàng hóa theo Luật Thương mại', hasItems:true,
    fields: [
      ...partyFields,
...
${renderSig(d.a_name||'',d.b_name||'')}`;
  ...
  // 6. HỢP ĐỒNG LAO ĐỘNG
  {
    id:'labor', icon:'👔', title:'Hợp Đồng Lao Động', desc:'Theo Bộ luật Lao động 2019 (Luật số 45/2019/QH14)', badge:'Quan trọng',
    fields: [
...
<p style="text-indent:2em">Căn cứ Bộ luật Lao động số 45/2019/QH14;</p>
...
${renderSig(d.a_name||'',d.b_name||'')}`;
  ...
  // 7. GIẤY ỦY QUYỀN
  {
    id:'poa', icon:'📝', title:'Giấy Ủy Quyền', desc:'Giấy ủy quyền theo Bộ luật Dân sự 2015',
    fields: [
...
${renderSig(d.a_name||'',d.b_name||'')}`;
  ...
  {
    id:'liquidation', icon:'📋', title:'Biên Bản Thanh Lý HĐ', desc:'Biên bản thanh lý hợp đồng khi hoàn thành',
    fields: [
      ...partyFields,
...
${renderSig(d.a_name||'',d.b_name||'')}`;
  ...
  {
    id:'handover', icon:'🤲', title:'Biên Bản Giao Nhận', desc:'Biên bản bàn giao tài sản, hàng hóa', hasItems:true,
    fields: [
      ...partyFields,
...
${renderSig(d.a_name||'',d.b_name||'')}`;
  ...
  // 10. GIẤY BIÊN NHẬN
  {
    id:'receipt', icon:'🧾', title:'Giấy Biên Nhận', desc:'Giấy xác nhận đã nhận tiền/tài sản',
    fields: [
